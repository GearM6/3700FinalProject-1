        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            while (scanning) {
                try {
                    ...
                    player2 = new Player(new Socket("127.0.0.1", 4000));
                    ...
                    while(gamesPlayed < numberOfGames){
                        ...
                        System.out.println("Tony threw " + player1Choice + ", Steve threw " + player2Choice +  " and I threw " + selection);
                    ...
                    System.out.println("Steve's Score: " + player2.read());
